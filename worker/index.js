// Server-side proxy to the Kimi (Moonshot AI) chat completions API. The
// browser only ever sees this Worker's own origin — the Kimi API key lives in
// a Wrangler secret and never reaches client-side JS. Only /api/* requests
// reach this script (see wrangler.jsonc's assets.run_worker_first); every
// other path is served as a static asset before the Worker ever runs.
